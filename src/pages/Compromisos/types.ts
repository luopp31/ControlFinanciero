...
export interface CompromisosViewProps {
  ...
  crearSuscripcion: (datos: { nombre: string; monto: number; diaCobro: number; categoria?: string | null }) => Promise<unknown>;
  actualizarSuscripcion: (
    id: string,
    datos: { nombre: string; monto: number; diaCobro: number; categoria?: string | null },
  ) => Promise<unknown>;
